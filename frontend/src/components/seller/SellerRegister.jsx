                        ...
                        <div className="card">
                            ...
                            {errorMsg && <p className='text-danger'>{errorMsg}</p>}
                                <form>
                                    ...
                                    <div className="mb-3">
                                        <label htmlFor="pwd" className="form-label">Address</label>
                                        <textarea type="text" name='address' onChange={inputHandler} value={registerFormData.address} className="form-control" id="address" ></textarea>
                                    </div>
